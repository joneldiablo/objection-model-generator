...
var e=(0,_knex2.default)({client:'mysql',connection:_extends({},b,{database:'information_schema'})});e.on('query',function(a){console.log('======== on query ==========');var b=0,c=a.sql.replace(/\?/g,function(){return'"'+a.bindings[b++]+'"'});console.log(c)}),_objection.Model.knex(e)}return _createClass(a,[{key:'createFiles',value:async function l(){var a=this.dbName,b=this.dbFile,c=_path2.default.join(__dirname,'../templates/'),d=_path2.default.join(c,'modelHeaderTemplate.mustache'),e=_path2.default.join(c,'modelTemplate.mustache'),f=await _fsExtra2.default.readFile(d,'UTF-8'),g=await _fsExtra2.default.readFile(e,'UTF-8'),h=_mustache2.default.render(f,{dbFile:b});_models.TableModel.dbName=a;var i=await _models.KeyColumnUsage.query().whereNotNull('REFERENCED_COLUMN_NAME').andWhere('table_schema','=',a),j=await _models.TableModel.query().where('table_schema','=',a).eager('[columns]'),k={classes:[],dbFile:b};return j.forEach(async function(a){var b=singularize(a.TABLE_NAME);b=camelCase(b),b=capitalize(b);var c=[],d=[],e=[],f={modelName:b+'Model',tableName:a.TABLE_NAME,properties:a.columns.map(function(b){c.push.apply(c,_toConsumableArray(i.filter(function(c){return a.TABLE_NAME===c.TABLE_NAME&&b.COLUMN_NAME===c.COLUMN_NAME}))),'NO'!==b.IS_NULLABLE||b.COLUMN_DEFAULT||'id'===b.COLUMN_NAME||d.push(b.COLUMN_NAME);var f=dataTypes(b.DATA_TYPE);return'string'===f&&searchFilter(b.COLUMN_NAME)&&e.push(b.COLUMN_NAME),{name:b.COLUMN_NAME,type:f}}),requireds:d,searches:e,relations:c.map(function(a){var b=singularize(a.REFERENCED_TABLE_NAME);return b=camelCase(b),{name:b,column:a.COLUMN_NAME,targetModel:capitalize(b)+'Model',targetTableName:a.REFERENCED_TABLE_NAME,targetColumn:a.REFERENCED_COLUMN_NAME}})};k.classes.push(f)}),h+=_mustache2.default.render(g,k),h}},{key:'version',get:function a(){return _package.version}}]),a}();exports.default=ObjectionModelGenerator,module.exports=exports.default,module.exports.default=exports.default;
