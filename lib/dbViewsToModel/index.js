...
module.exports = async function (dbName, dbConnection, knexInstance, outputModelFile) {
  ...
  var ViewModel = function (_Model3) {
    _inherits(ViewModel, _Model3);

    function ViewModel() {
      _classCallCheck(this, ViewModel);

      return _possibleConstructorReturn(this, (ViewModel.__proto__ || Object.getPrototypeOf(ViewModel)).apply(this, arguments));
    }
  ...
  var views = await ViewModel.query().where('table_schema', '=', DB).eager('[columns.[constrain]]');
  var classModelNames = {
    classes: []
  };
  views.forEach(function (view) {
    var modelName = singularize(view.TABLE_NAME);
    ...
    var data = {
      ...
      properties: view.columns.map(function (column) {
        if (column.constrain) {
